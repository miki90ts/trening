    ...
    <div className="page dashboard">
      ...
      <div className="stats-grid">
        <Card className="stat-card">
          ...
          <div className="stat-info">
            <span className="stat-number">
              {summary?.stats?.total_users || users.length}
            </span>
        ...
        <Card className="stat-card">
          ...
          <div className="stat-info">
            <span className="stat-number">
              {summary?.stats?.total_exercises || exercises.length}
            </span>
        ...
        <Card className="stat-card">
          ...
          <div className="stat-info">
            <span className="stat-number">
              {summary?.stats?.total_attempts || 0}
            </span>
                ...
                <Card className="user-card">
                  ...
                  <div>
                    ...
                    <div className="user-info">
                      ...
                      <span className="user-records-count">
                        {user.total_records} rekord(a)
                      </span>
                    </div>
                  </div>
                </Card>
          ...
          <div className="cards-grid">
            {summary.recent_records.map((record) => (
              <Card key={record.id} className="record-card">
                ...
                <div className="record-value">{parseFloat(record.score)}</div>
