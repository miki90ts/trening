...
function SleepStreakCard({ streak }) {
  if (!streak) return null;

  const { current_streak, longest_streak, total_target_days } = streak;
  ...
  return (
    <Card className="hydration-streak-card">
      ...
      <div className="hydration-streak-grid">
        <div className={`hydration-streak-item hydration-streak-current ${getFlameSize(current_streak)}`}>
          ...
          <div className="hydration-streak-info">
            ...
            <span className="hydration-streak-label">{current_streak === 1 ? "noć" : "noći"} zaredom ≥ cilj</span>
          </div>
        </div>
        ...
        <div className="hydration-streak-item">
          ...
          <div className="hydration-streak-info">
            <span className="hydration-streak-count">{total_target_days}</span>
            <span className="hydration-streak-label">ukupno noći sa ciljem</span>
          </div>
        </div>
      </div>
    </Card>
