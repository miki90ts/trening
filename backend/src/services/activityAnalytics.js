...
async function getPeriodStatsPayload(userId, granularity, anchor) {
...
async function getPeriodStats(userId, query) {
  ...
  return getPeriodStatsPayload(userId, granularity, anchor);
}

async function getPeriodExport(userId, query) {
  const payload = await getPeriodStats(userId, query);
  return {
    ...payload,
